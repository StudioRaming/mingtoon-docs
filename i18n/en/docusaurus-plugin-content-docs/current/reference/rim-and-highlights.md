...
title: Rims and accent light
sidebar_position: 4
---

# Rims and accent light

These lift the silhouette and separate the character from the background. They stack fast, so raise one at a time.
